...
//just defining the variable, not sure if I need to do this
//$category_id;



//if the category has been inserted into the database...
...
$sql2 = "INSERT INTO review VALUES(NULL,'$category_id','{$category}','$user_id', '{$name}','{$phonenumber}','{$address}', '{$comment}')";
